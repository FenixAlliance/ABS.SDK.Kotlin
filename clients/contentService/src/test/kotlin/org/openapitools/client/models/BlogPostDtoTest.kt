...
class BlogPostDtoTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of BlogPostDto
        //val modelInstance = BlogPostDto()
        ...
        // to test the property `blogPostCategoryID`
        should("test blogPostCategoryID") {
            // uncomment below to test the property
            //modelInstance.blogPostCategoryID shouldBe ("TODO")
        }
