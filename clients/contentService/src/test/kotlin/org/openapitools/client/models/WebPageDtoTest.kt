...
import org.openapitools.client.models.WebPageDto

class WebPageDtoTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of WebPageDto
        //val modelInstance = WebPageDto()
        ...
        // to test the property `isHomePage`
        should("test isHomePage") {
            // uncomment below to test the property
            //modelInstance.isHomePage shouldBe ("TODO")
        }

        // to test the property `isStorePage`
        should("test isStorePage") {
            // uncomment below to test the property
            //modelInstance.isStorePage shouldBe ("TODO")
        }

        // to test the property `isCartPage`
        should("test isCartPage") {
            // uncomment below to test the property
            //modelInstance.isCartPage shouldBe ("TODO")
        }

        // to test the property `isBlogPage`
        should("test isBlogPage") {
            // uncomment below to test the property
            //modelInstance.isBlogPage shouldBe ("TODO")
        }

        // to test the property `isAccountPage`
        should("test isAccountPage") {
            // uncomment below to test the property
            //modelInstance.isAccountPage shouldBe ("TODO")
        }

        // to test the property `isCheckoutPage`
        should("test isCheckoutPage") {
            // uncomment below to test the property
            //modelInstance.isCheckoutPage shouldBe ("TODO")
        }

        // to test the property `isWishListsPage`
        should("test isWishListsPage") {
            // uncomment below to test the property
            //modelInstance.isWishListsPage shouldBe ("TODO")
        }

        // to test the property `isContactPage`
        should("test isContactPage") {
            // uncomment below to test the property
            //modelInstance.isContactPage shouldBe ("TODO")
        }

        // to test the property `isPrivacyPolicyPage`
        should("test isPrivacyPolicyPage") {
            // uncomment below to test the property
            //modelInstance.isPrivacyPolicyPage shouldBe ("TODO")
        }

        // to test the property `isTermsOfServicePage`
        should("test isTermsOfServicePage") {
            // uncomment below to test the property
            //modelInstance.isTermsOfServicePage shouldBe ("TODO")
        }
