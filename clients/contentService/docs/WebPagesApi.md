...
# **patchWebPageAsync**
> patchWebPageAsync(webPageId, tenantId, apiVersion, xApiVersion, operation)
...
try {
    apiInstance.patchWebPageAsync(webPageId, tenantId, apiVersion, xApiVersion, operation)
} catch (e: ClientException) {
