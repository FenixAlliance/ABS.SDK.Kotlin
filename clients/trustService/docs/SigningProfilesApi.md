...
> SigningProfileDtoListEnvelope getSigningProfilesAsync(tenantId, apiVersion, xApiVersion)
...
> Int32Envelope getSigningProfilesCountAsync(tenantId, apiVersion, xApiVersion)
...
> EmptyEnvelope patchSigningProfileAsync(id, tenantId, apiVersion, xApiVersion, operation)
