...
class AccountGroupCreateDtoTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of AccountGroupCreateDto
        //val modelInstance = AccountGroupCreateDto()
        ...
        // to test the property `parentAccountGroupId`
        should("test parentAccountGroupId") {
            // uncomment below to test the property
            //modelInstance.parentAccountGroupId shouldBe ("TODO")
        }
