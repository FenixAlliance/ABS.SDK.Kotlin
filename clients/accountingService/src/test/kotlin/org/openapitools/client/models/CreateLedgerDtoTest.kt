...
class CreateLedgerDtoTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of CreateLedgerDto
        //val modelInstance = CreateLedgerDto()
        ...
        // to test the property `ledgerTypeId`
        should("test ledgerTypeId") {
            // uncomment below to test the property
            //modelInstance.ledgerTypeId shouldBe ("TODO")
        }
