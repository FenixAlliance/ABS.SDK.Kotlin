...
val apiVersion : kotlin.String = apiVersion_example // kotlin.String | 
val xApiVersion : kotlin.String = xApiVersion_example // kotlin.String | 
val expenseClaimDtoCollectionQueryParameters : ExpenseClaimDtoCollectionQueryParameters =  // ExpenseClaimDtoCollectionQueryParameters | 
try {
    val result : ExpenseClaimDtoListEnvelope = apiInstance.getExpenseClaims(tenantId, apiVersion, xApiVersion, expenseClaimDtoCollectionQueryParameters)
    println(result)
} catch (e: ClientException) {
...
val expenseClaimDtoCollectionQueryParameters : ExpenseClaimDtoCollectionQueryParameters =  // ExpenseClaimDtoCollectionQueryParameters | 
try {
    val result : Int32Envelope = apiInstance.getExpenseClaimsCount(tenantId, apiVersion, xApiVersion, expenseClaimDtoCollectionQueryParameters)
    println(result)
} catch (e: ClientException) {
...
# **patchExpenseClaim**
> EmptyEnvelope patchExpenseClaim(expenseClaimId, tenantId, apiVersion, xApiVersion, patchOperation)
...
try {
    val result : EmptyEnvelope = apiInstance.patchExpenseClaim(expenseClaimId, tenantId, apiVersion, xApiVersion, patchOperation)
    println(result)
} catch (e: ClientException) {
