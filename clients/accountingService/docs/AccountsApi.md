...
try {
    ...
    println("5xx response calling AccountsApi#patchAccountEntryAsync")
    e.printStackTrace()
}
```
...
try {
    ...
    println("5xx response calling AccountsApi#patchAccountRelationAsync")
    e.printStackTrace()
}
```
...
try {
    ...
    println("5xx response calling AccountsApi#patchAccountTypeAsync")
    e.printStackTrace()
}
```
