...
# **getGrantsAsync**
> GrantDtoIReadOnlyListEnvelope getGrantsAsync(tenantId, apiVersion, xApiVersion, grantDtoCollectionQueryParameters)
...
val apiVersion : kotlin.String = apiVersion_example // kotlin.String | 
val xApiVersion : kotlin.String = xApiVersion_example // kotlin.String | 
val grantDtoCollectionQueryParameters : GrantDtoCollectionQueryParameters =  // GrantDtoCollectionQueryParameters | 
try {
    val result : GrantDtoIReadOnlyListEnvelope = apiInstance.getGrantsAsync(tenantId, apiVersion, xApiVersion, grantDtoCollectionQueryParameters)
    println(result)
} catch (e: ClientException) {
...
# **getGrantsCountAsync**
> Int32Envelope getGrantsCountAsync(tenantId, apiVersion, xApiVersion, grantDtoCollectionQueryParameters)
...
val grantDtoCollectionQueryParameters : GrantDtoCollectionQueryParameters =  // GrantDtoCollectionQueryParameters | 
try {
    val result : Int32Envelope = apiInstance.getGrantsCountAsync(tenantId, apiVersion, xApiVersion, grantDtoCollectionQueryParameters)
    println(result)
} catch (e: ClientException) {
...
# **patchGrantAsync**
> EmptyEnvelope patchGrantAsync(grantId, tenantId, apiVersion, xApiVersion, patchOperation)
...
try {
    val result : EmptyEnvelope = apiInstance.patchGrantAsync(grantId, tenantId, apiVersion, xApiVersion, patchOperation)
    println(result)
} catch (e: ClientException) {
