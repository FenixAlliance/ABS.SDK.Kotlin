...
# **patchLedgerAsync**
> EmptyEnvelope patchLedgerAsync(ledgerId, tenantId, apiVersion, xApiVersion, operation)
...
try {
    val result : EmptyEnvelope = apiInstance.patchLedgerAsync(ledgerId, tenantId, apiVersion, xApiVersion, operation)
    println(result)
} catch (e: ClientException) {
