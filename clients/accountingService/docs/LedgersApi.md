...
# **getLedgersAsync**
> LedgerDtoIReadOnlyListEnvelope getLedgersAsync(tenantId, apiVersion, xApiVersion, ledgerDtoCollectionQueryParameters)
...
val apiVersion : kotlin.String = apiVersion_example // kotlin.String | 
val xApiVersion : kotlin.String = xApiVersion_example // kotlin.String | 
val ledgerDtoCollectionQueryParameters : LedgerDtoCollectionQueryParameters =  // LedgerDtoCollectionQueryParameters | 
try {
    val result : LedgerDtoIReadOnlyListEnvelope = apiInstance.getLedgersAsync(tenantId, apiVersion, xApiVersion, ledgerDtoCollectionQueryParameters)
    println(result)
} catch (e: ClientException) {
...
> Int32Envelope getLedgersCountAsync(tenantId, apiVersion, xApiVersion, ledgerDtoCollectionQueryParameters)
...
val ledgerDtoCollectionQueryParameters : LedgerDtoCollectionQueryParameters =  // LedgerDtoCollectionQueryParameters | 
try {
    val result : Int32Envelope = apiInstance.getLedgersCountAsync(tenantId, apiVersion, xApiVersion, ledgerDtoCollectionQueryParameters)
    println(result)
} catch (e: ClientException) {
...
# **patchLedgerAsync**
> EmptyEnvelope patchLedgerAsync(ledgerId, tenantId, apiVersion, xApiVersion, patchOperation)
...
try {
    val result : EmptyEnvelope = apiInstance.patchLedgerAsync(ledgerId, tenantId, apiVersion, xApiVersion, patchOperation)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling LedgersApi#patchLedgerAsync")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling LedgersApi#patchLedgerAsync")
    e.printStackTrace()
}
```
