...
val apiVersion : kotlin.String = apiVersion_example // kotlin.String | 
val xApiVersion : kotlin.String = xApiVersion_example // kotlin.String | 
val taxRateDtoCollectionQueryParameters : TaxRateDtoCollectionQueryParameters =  // TaxRateDtoCollectionQueryParameters | 
try {
    val result : TaxRateDtoListEnvelope = apiInstance.getTaxRates(tenantId, apiVersion, xApiVersion, taxRateDtoCollectionQueryParameters)
    println(result)
} catch (e: ClientException) {
...
val taxRateDtoCollectionQueryParameters : TaxRateDtoCollectionQueryParameters =  // TaxRateDtoCollectionQueryParameters | 
try {
    val result : Int32Envelope = apiInstance.getTaxRatesCount(tenantId, apiVersion, xApiVersion, taxRateDtoCollectionQueryParameters)
    println(result)
} catch (e: ClientException) {
...
<a id="patchTaxRate"></a>
# **patchTaxRate**
> EmptyEnvelope patchTaxRate(id, tenantId, apiVersion, xApiVersion, patchOperation)
...
try {
    val result : EmptyEnvelope = apiInstance.patchTaxRate(id, tenantId, apiVersion, xApiVersion, patchOperation)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling TaxRatesApi#patchTaxRate")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling TaxRatesApi#patchTaxRate")
    e.printStackTrace()
}
```
