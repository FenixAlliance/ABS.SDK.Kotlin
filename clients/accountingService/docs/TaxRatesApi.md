...
<a id="patchTaxRate"></a>
# **patchTaxRate**
> EmptyEnvelope patchTaxRate(id, tenantId, apiVersion, xApiVersion, operation)
...
try {
    val result : EmptyEnvelope = apiInstance.patchTaxRate(id, tenantId, apiVersion, xApiVersion, operation)
    println(result)
} catch (e: ClientException) {
