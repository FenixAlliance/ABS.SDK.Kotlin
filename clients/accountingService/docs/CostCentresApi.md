...
try {
    ...
    println("5xx response calling CostCentresApi#patchCostCentre")
    e.printStackTrace()
}
```
...
try {
    ...
    println("5xx response calling CostCentresApi#patchCostCentreBudget")
    e.printStackTrace()
}
```
...
try {
    ...
    println("5xx response calling CostCentresApi#patchCostCentreGroup")
    e.printStackTrace()
}
```
