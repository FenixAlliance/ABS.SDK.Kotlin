...
try {
    ...
    println("5xx response calling BudgetsApi#getBudgetsCountAsync")
    e.printStackTrace()
}
```
...
try {
    ...
    println("5xx response calling BudgetsApi#patchBudgetAccountEntryAsync")
    e.printStackTrace()
}
```
...
try {
    ...
    println("5xx response calling BudgetsApi#patchBudgetAsync")
    e.printStackTrace()
}
```
