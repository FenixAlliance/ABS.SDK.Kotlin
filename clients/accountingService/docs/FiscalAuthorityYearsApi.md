...
> EmptyEnvelope patchFiscalAuthorityYearAsync(fiscalYearId, tenantId, apiVersion, xApiVersion, operation)
...
try {
    val result : EmptyEnvelope = apiInstance.patchFiscalAuthorityYearAsync(fiscalYearId, tenantId, apiVersion, xApiVersion, operation)
    println(result)
} catch (e: ClientException) {
