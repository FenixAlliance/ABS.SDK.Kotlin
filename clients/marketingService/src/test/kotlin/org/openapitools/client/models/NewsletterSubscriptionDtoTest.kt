...
class NewsletterSubscriptionDtoTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of NewsletterSubscriptionDto
        //val modelInstance = NewsletterSubscriptionDto()
