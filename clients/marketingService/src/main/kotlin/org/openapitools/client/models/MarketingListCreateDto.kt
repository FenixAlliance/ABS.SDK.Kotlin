...
data class MarketingListCreateDto (
    ...
    val marketingListType: MarketingListCreateDto.MarketingListType? = null,

    @Json(name = "marketingListTarget")
    val marketingListTarget: MarketingListCreateDto.MarketingListTarget? = null
