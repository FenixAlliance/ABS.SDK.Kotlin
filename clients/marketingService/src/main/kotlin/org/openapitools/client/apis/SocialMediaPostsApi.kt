...
import org.openapitools.client.models.SocialMediaPostDtoCollectionQueryParameters
...
class SocialMediaPostsApi(basePath: kotlin.String = defaultBasePath, client: Call.Factory = ApiClient.defaultClient) : ApiClient(basePath, client) {
     ...
     * @param apiVersion  (optional)
     * @param xApiVersion  (optional)
     * @param socialMediaPostDtoCollectionQueryParameters  (optional)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getSocialMediaPostsCountAsync(tenantId: java.util.UUID, apiVersion: kotlin.String? = null, xApiVersion: kotlin.String? = null, socialMediaPostDtoCollectionQueryParameters: SocialMediaPostDtoCollectionQueryParameters? = null) : Int32Envelope {
        val localVarResponse = getSocialMediaPostsCountAsyncWithHttpInfo(tenantId = tenantId, apiVersion = apiVersion, xApiVersion = xApiVersion, socialMediaPostDtoCollectionQueryParameters = socialMediaPostDtoCollectionQueryParameters)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getSocialMediaPostsCountAsyncWithHttpInfo(tenantId: java.util.UUID, apiVersion: kotlin.String?, xApiVersion: kotlin.String?, socialMediaPostDtoCollectionQueryParameters: SocialMediaPostDtoCollectionQueryParameters?) : ApiResponse<Int32Envelope?> {
        val localVariableConfig = getSocialMediaPostsCountAsyncRequestConfig(tenantId = tenantId, apiVersion = apiVersion, xApiVersion = xApiVersion, socialMediaPostDtoCollectionQueryParameters = socialMediaPostDtoCollectionQueryParameters)

        return request<SocialMediaPostDtoCollectionQueryParameters, Int32Envelope>(
            localVariableConfig
        )
    }
     ...
     * @return RequestConfig
     */
    fun getSocialMediaPostsCountAsyncRequestConfig(tenantId: java.util.UUID, apiVersion: kotlin.String?, xApiVersion: kotlin.String?, socialMediaPostDtoCollectionQueryParameters: SocialMediaPostDtoCollectionQueryParameters?) : RequestConfig<SocialMediaPostDtoCollectionQueryParameters> {
        val localVariableBody = socialMediaPostDtoCollectionQueryParameters
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>()
            .apply {
                put("tenantId", listOf(tenantId.toString()))
                if (apiVersion != null) {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getSocialMediaPostsODataAsync(tenantId: java.util.UUID, apiVersion: kotlin.String? = null, xApiVersion: kotlin.String? = null, socialMediaPostDtoCollectionQueryParameters: SocialMediaPostDtoCollectionQueryParameters? = null) : SocialMediaPostDtoListEnvelope {
        val localVarResponse = getSocialMediaPostsODataAsyncWithHttpInfo(tenantId = tenantId, apiVersion = apiVersion, xApiVersion = xApiVersion, socialMediaPostDtoCollectionQueryParameters = socialMediaPostDtoCollectionQueryParameters)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getSocialMediaPostsODataAsyncWithHttpInfo(tenantId: java.util.UUID, apiVersion: kotlin.String?, xApiVersion: kotlin.String?, socialMediaPostDtoCollectionQueryParameters: SocialMediaPostDtoCollectionQueryParameters?) : ApiResponse<SocialMediaPostDtoListEnvelope?> {
        val localVariableConfig = getSocialMediaPostsODataAsyncRequestConfig(tenantId = tenantId, apiVersion = apiVersion, xApiVersion = xApiVersion, socialMediaPostDtoCollectionQueryParameters = socialMediaPostDtoCollectionQueryParameters)

        return request<SocialMediaPostDtoCollectionQueryParameters, SocialMediaPostDtoListEnvelope>(
            localVariableConfig
        )
    }
     ...
     * @return RequestConfig
     */
    fun getSocialMediaPostsODataAsyncRequestConfig(tenantId: java.util.UUID, apiVersion: kotlin.String?, xApiVersion: kotlin.String?, socialMediaPostDtoCollectionQueryParameters: SocialMediaPostDtoCollectionQueryParameters?) : RequestConfig<SocialMediaPostDtoCollectionQueryParameters> {
        val localVariableBody = socialMediaPostDtoCollectionQueryParameters
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>()
            .apply {
                put("tenantId", listOf(tenantId.toString()))
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun patchSocialMediaPostAsync(socialmediapostId: java.util.UUID, tenantId: java.util.UUID, apiVersion: kotlin.String? = null, xApiVersion: kotlin.String? = null, patchOperation: kotlin.collections.List<PatchOperation>? = null) : EmptyEnvelope {
        val localVarResponse = patchSocialMediaPostAsyncWithHttpInfo(socialmediapostId = socialmediapostId, tenantId = tenantId, apiVersion = apiVersion, xApiVersion = xApiVersion, patchOperation = patchOperation)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun patchSocialMediaPostAsyncWithHttpInfo(socialmediapostId: java.util.UUID, tenantId: java.util.UUID, apiVersion: kotlin.String?, xApiVersion: kotlin.String?, patchOperation: kotlin.collections.List<PatchOperation>?) : ApiResponse<EmptyEnvelope?> {
        val localVariableConfig = patchSocialMediaPostAsyncRequestConfig(socialmediapostId = socialmediapostId, tenantId = tenantId, apiVersion = apiVersion, xApiVersion = xApiVersion, patchOperation = patchOperation)
    ...
    /**
     * To obtain the request config of the operation patchSocialMediaPostAsync
     *
     * @param socialmediapostId 
     * @param tenantId 
     * @param apiVersion  (optional)
     ...
     * @return RequestConfig
     */
    fun patchSocialMediaPostAsyncRequestConfig(socialmediapostId: java.util.UUID, tenantId: java.util.UUID, apiVersion: kotlin.String?, xApiVersion: kotlin.String?, patchOperation: kotlin.collections.List<PatchOperation>?) : RequestConfig<kotlin.collections.List<PatchOperation>> {
