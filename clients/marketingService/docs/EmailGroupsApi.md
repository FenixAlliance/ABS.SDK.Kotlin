...
val apiVersion : kotlin.String = apiVersion_example // kotlin.String | 
val xApiVersion : kotlin.String = xApiVersion_example // kotlin.String | 
val emailGroupDtoCollectionQueryParameters : EmailGroupDtoCollectionQueryParameters =  // EmailGroupDtoCollectionQueryParameters | 
try {
    val result : Int32Envelope = apiInstance.getEmailGroupsCountAsync(tenantId, apiVersion, xApiVersion, emailGroupDtoCollectionQueryParameters)
    println(result)
} catch (e: ClientException) {
...
val emailGroupDtoCollectionQueryParameters : EmailGroupDtoCollectionQueryParameters =  // EmailGroupDtoCollectionQueryParameters | 
try {
    val result : EmailGroupDtoListEnvelope = apiInstance.getEmailGroupsODataAsync(tenantId, apiVersion, xApiVersion, emailGroupDtoCollectionQueryParameters)
    println(result)
} catch (e: ClientException) {
...
> EmptyEnvelope patchEmailGroupAsync(emailgroupId, tenantId, apiVersion, xApiVersion, patchOperation)
...
try {
    val result : EmptyEnvelope = apiInstance.patchEmailGroupAsync(emailgroupId, tenantId, apiVersion, xApiVersion, patchOperation)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling EmailGroupsApi#patchEmailGroupAsync")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling EmailGroupsApi#patchEmailGroupAsync")
    e.printStackTrace()
}
```
