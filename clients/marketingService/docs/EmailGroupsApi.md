...
> EmptyEnvelope patchEmailGroupAsync(emailgroupId, tenantId, apiVersion, xApiVersion, operation)
...
try {
    val result : EmptyEnvelope = apiInstance.patchEmailGroupAsync(emailgroupId, tenantId, apiVersion, xApiVersion, operation)
    println(result)
} catch (e: ClientException) {
