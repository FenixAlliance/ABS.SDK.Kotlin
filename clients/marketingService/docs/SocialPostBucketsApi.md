...
> Int32Envelope getSocialPostBucketsCountAsync(tenantId, apiVersion, xApiVersion, socialPostBucketDtoCollectionQueryParameters)
...
val apiVersion : kotlin.String = apiVersion_example // kotlin.String | 
val xApiVersion : kotlin.String = xApiVersion_example // kotlin.String | 
val socialPostBucketDtoCollectionQueryParameters : SocialPostBucketDtoCollectionQueryParameters =  // SocialPostBucketDtoCollectionQueryParameters | 
try {
    val result : Int32Envelope = apiInstance.getSocialPostBucketsCountAsync(tenantId, apiVersion, xApiVersion, socialPostBucketDtoCollectionQueryParameters)
    println(result)
} catch (e: ClientException) {
...
> SocialPostBucketDtoListEnvelope getSocialPostBucketsODataAsync(tenantId, apiVersion, xApiVersion, socialPostBucketDtoCollectionQueryParameters)
...
val socialPostBucketDtoCollectionQueryParameters : SocialPostBucketDtoCollectionQueryParameters =  // SocialPostBucketDtoCollectionQueryParameters | 
try {
    val result : SocialPostBucketDtoListEnvelope = apiInstance.getSocialPostBucketsODataAsync(tenantId, apiVersion, xApiVersion, socialPostBucketDtoCollectionQueryParameters)
    println(result)
} catch (e: ClientException) {
...
<a id="patchSocialPostBucketAsync"></a>
# **patchSocialPostBucketAsync**
> EmptyEnvelope patchSocialPostBucketAsync(socialpostbucketId, tenantId, apiVersion, xApiVersion, patchOperation)
...
try {
    val result : EmptyEnvelope = apiInstance.patchSocialPostBucketAsync(socialpostbucketId, tenantId, apiVersion, xApiVersion, patchOperation)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling SocialPostBucketsApi#patchSocialPostBucketAsync")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling SocialPostBucketsApi#patchSocialPostBucketAsync")
    e.printStackTrace()
}
```
