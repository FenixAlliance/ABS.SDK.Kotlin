...
> EmptyEnvelope patchSocialPostBucketAsync(socialpostbucketId, tenantId, apiVersion, xApiVersion, operation)
...
try {
    val result : EmptyEnvelope = apiInstance.patchSocialPostBucketAsync(socialpostbucketId, tenantId, apiVersion, xApiVersion, operation)
    println(result)
} catch (e: ClientException) {
