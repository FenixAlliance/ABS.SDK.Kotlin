...
val apiVersion : kotlin.String = apiVersion_example // kotlin.String | 
val xApiVersion : kotlin.String = xApiVersion_example // kotlin.String | 
val emailTemplateDtoCollectionQueryParameters : EmailTemplateDtoCollectionQueryParameters =  // EmailTemplateDtoCollectionQueryParameters | 
try {
    val result : Int32Envelope = apiInstance.getEmailTemplatesCountAsync(tenantId, apiVersion, xApiVersion, emailTemplateDtoCollectionQueryParameters)
    println(result)
} catch (e: ClientException) {
...
val emailTemplateDtoCollectionQueryParameters : EmailTemplateDtoCollectionQueryParameters =  // EmailTemplateDtoCollectionQueryParameters | 
try {
    val result : EmailTemplateDtoListEnvelope = apiInstance.getEmailTemplatesODataAsync(tenantId, apiVersion, xApiVersion, emailTemplateDtoCollectionQueryParameters)
    println(result)
} catch (e: ClientException) {
...
> EmptyEnvelope patchEmailTemplateAsync(emailTemplateId, tenantId, apiVersion, xApiVersion, patchOperation)
...
try {
    val result : EmptyEnvelope = apiInstance.patchEmailTemplateAsync(emailTemplateId, tenantId, apiVersion, xApiVersion, patchOperation)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling EmailTemplatesApi#patchEmailTemplateAsync")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling EmailTemplatesApi#patchEmailTemplateAsync")
    e.printStackTrace()
}
```
