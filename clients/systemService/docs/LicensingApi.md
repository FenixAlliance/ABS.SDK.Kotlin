...
> SuiteLicenseAssignmentDtoListEnvelope getAttributesForLicenseAsync(licenseId, tenantId, apiVersion, xApiVersion)
...
try {
    val result : SuiteLicenseAssignmentDtoListEnvelope = apiInstance.getAttributesForLicenseAsync(licenseId, tenantId, apiVersion, xApiVersion)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling LicensingApi#getAttributesForLicenseAsync")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling LicensingApi#getAttributesForLicenseAsync")
    e.printStackTrace()
}
```
...
> SuiteLicenseAssignmentDtoListEnvelope getFeaturesForLicenseAsync(licenseId, tenantId, apiVersion, xApiVersion)
...
val xApiVersion : kotlin.String = xApiVersion_example // kotlin.String | 
try {
    val result : SuiteLicenseAssignmentDtoListEnvelope = apiInstance.getFeaturesForLicenseAsync(licenseId, tenantId, apiVersion, xApiVersion)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling LicensingApi#getFeaturesForLicenseAsync")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling LicensingApi#getFeaturesForLicenseAsync")
    e.printStackTrace()
}
```
