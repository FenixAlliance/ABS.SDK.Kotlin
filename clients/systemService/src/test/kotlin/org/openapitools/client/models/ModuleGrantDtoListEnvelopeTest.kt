...
class ModuleGrantDtoListEnvelopeTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of ModuleGrantDtoListEnvelope
        //val modelInstance = ModuleGrantDtoListEnvelope()
