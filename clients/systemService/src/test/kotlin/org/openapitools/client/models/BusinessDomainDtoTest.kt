...
class BusinessDomainDtoTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of BusinessDomainDto
        //val modelInstance = BusinessDomainDto()
        ...
        // to test the property `txtRecord`
        should("test txtRecord") {
            // uncomment below to test the property
            //modelInstance.txtRecord shouldBe ("TODO")
        }
