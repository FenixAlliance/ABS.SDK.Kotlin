...
import org.openapitools.client.models.SuiteModule
import org.openapitools.client.models.IOpenApiDefinitionSpec

class SuiteModuleTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of SuiteModule
        //val modelInstance = SuiteModule()
        ...
        // to test the property `openApiDefinitionSpec`
        should("test openApiDefinitionSpec") {
            // uncomment below to test the property
            //modelInstance.openApiDefinitionSpec shouldBe ("TODO")
        }
        ...
        // to test the property `requiredPermissions`
        should("test requiredPermissions") {
            // uncomment below to test the property
            //modelInstance.requiredPermissions shouldBe ("TODO")
        }
