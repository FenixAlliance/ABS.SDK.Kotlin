...
> SubscriptionDtoIReadOnlyListEnvelope getSubscriptionsAsync(tenantId, apiVersion, xApiVersion, subscriptionDtoCollectionQueryParameters)
...
val apiVersion : kotlin.String = apiVersion_example // kotlin.String | 
val xApiVersion : kotlin.String = xApiVersion_example // kotlin.String | 
val subscriptionDtoCollectionQueryParameters : SubscriptionDtoCollectionQueryParameters =  // SubscriptionDtoCollectionQueryParameters | 
try {
    val result : SubscriptionDtoIReadOnlyListEnvelope = apiInstance.getSubscriptionsAsync(tenantId, apiVersion, xApiVersion, subscriptionDtoCollectionQueryParameters)
    println(result)
} catch (e: ClientException) {
...
> Int32Envelope getSubscriptionsCountAsync(tenantId, apiVersion, xApiVersion, subscriptionDtoCollectionQueryParameters)
...
val subscriptionDtoCollectionQueryParameters : SubscriptionDtoCollectionQueryParameters =  // SubscriptionDtoCollectionQueryParameters | 
try {
    val result : Int32Envelope = apiInstance.getSubscriptionsCountAsync(tenantId, apiVersion, xApiVersion, subscriptionDtoCollectionQueryParameters)
    println(result)
} catch (e: ClientException) {
...
<a id="patchSubscriptionAsync"></a>
# **patchSubscriptionAsync**
> EmptyEnvelope patchSubscriptionAsync(subscriptionId, tenantId, apiVersion, xApiVersion, patchOperation)
...
try {
    val result : EmptyEnvelope = apiInstance.patchSubscriptionAsync(subscriptionId, tenantId, apiVersion, xApiVersion, patchOperation)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling SubscriptionsApi#patchSubscriptionAsync")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling SubscriptionsApi#patchSubscriptionAsync")
    e.printStackTrace()
}
```
