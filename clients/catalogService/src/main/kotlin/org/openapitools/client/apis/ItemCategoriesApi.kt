...
class ItemCategoriesApi(basePath: kotlin.String = defaultBasePath, client: Call.Factory = ApiClient.defaultClient) : ApiClient(basePath, client) {
    companion object {
        @JvmStatic
    ...
    fun countItemCategoriesAsyncRequestConfig(tenantId: java.util.UUID?, apiVersion: kotlin.String?, xApiVersion: kotlin.String?, itemCategoryDtoCollectionQueryParameters: ItemCategoryDtoCollectionQueryParameters?) : RequestConfig<ItemCategoryDtoCollectionQueryParameters> {
        ...
        return RequestConfig(
            ...
            path = "/api/v2/CatalogService/ItemCategories/Count",
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun createItemCategoryAsync(tenantId: java.util.UUID, apiVersion: kotlin.String? = null, xApiVersion: kotlin.String? = null, itemCategoryCreateDto: ItemCategoryCreateDto? = null) : ItemCategoryDtoEnvelope {
        val localVarResponse = createItemCategoryAsyncWithHttpInfo(tenantId = tenantId, apiVersion = apiVersion, xApiVersion = xApiVersion, itemCategoryCreateDto = itemCategoryCreateDto)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun createItemCategoryAsyncWithHttpInfo(tenantId: java.util.UUID, apiVersion: kotlin.String?, xApiVersion: kotlin.String?, itemCategoryCreateDto: ItemCategoryCreateDto?) : ApiResponse<ItemCategoryDtoEnvelope?> {
        val localVariableConfig = createItemCategoryAsyncRequestConfig(tenantId = tenantId, apiVersion = apiVersion, xApiVersion = xApiVersion, itemCategoryCreateDto = itemCategoryCreateDto)

        return request<ItemCategoryCreateDto, ItemCategoryDtoEnvelope>(
            localVariableConfig
        )
    }

    /**
     * To obtain the request config of the operation createItemCategoryAsync
     *
     * @param tenantId 
     * @param apiVersion  (optional)
     * @param xApiVersion  (optional)
     ...
     * @return RequestConfig
     */
    fun createItemCategoryAsyncRequestConfig(tenantId: java.util.UUID, apiVersion: kotlin.String?, xApiVersion: kotlin.String?, itemCategoryCreateDto: ItemCategoryCreateDto?) : RequestConfig<ItemCategoryCreateDto> {
        val localVariableBody = itemCategoryCreateDto
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>()
            .apply {
                put("tenantId", listOf(tenantId.toString()))
                if (apiVersion != null) {
        ...
        return RequestConfig(
            ...
            path = "/api/v2/CatalogService/ItemCategories",
            query = localVariableQuery,
            headers = localVariableHeaders,
            requiresAuthentication = false,
            body = localVariableBody
     ...
     */
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun deleteItemCategoryAsync(itemCategoryId: java.util.UUID, tenantId: java.util.UUID, apiVersion: kotlin.String? = null, xApiVersion: kotlin.String? = null) : Unit {
        val localVarResponse = deleteItemCategoryAsyncWithHttpInfo(itemCategoryId = itemCategoryId, tenantId = tenantId, apiVersion = apiVersion, xApiVersion = xApiVersion)
     ...
     */
    @Throws(IllegalStateException::class, IOException::class)
    fun deleteItemCategoryAsyncWithHttpInfo(itemCategoryId: java.util.UUID, tenantId: java.util.UUID, apiVersion: kotlin.String?, xApiVersion: kotlin.String?) : ApiResponse<Unit?> {
        val localVariableConfig = deleteItemCategoryAsyncRequestConfig(itemCategoryId = itemCategoryId, tenantId = tenantId, apiVersion = apiVersion, xApiVersion = xApiVersion)
    ...
    /**
     * To obtain the request config of the operation deleteItemCategoryAsync
     *
     * @param itemCategoryId 
     * @param tenantId 
     * @param apiVersion  (optional)
     ...
     * @return RequestConfig
     */
    fun deleteItemCategoryAsyncRequestConfig(itemCategoryId: java.util.UUID, tenantId: java.util.UUID, apiVersion: kotlin.String?, xApiVersion: kotlin.String?) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            ...
            path = "/api/v2/CatalogService/ItemCategories/{itemCategoryId}".replace("{"+"itemCategoryId"+"}", encodeURIComponent(itemCategoryId.toString())),
            query = localVariableQuery,
            headers = localVariableHeaders,
            requiresAuthentication = false,
            body = localVariableBody
    ...
    /**
     * To obtain the request config of the operation patchItemCategoryAsync
     *
     * @param itemCategoryId 
     * @param tenantId 
     * @param apiVersion  (optional)
     ...
     */
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun updateItemCategoryAsync(itemCategoryId: java.util.UUID, tenantId: java.util.UUID, apiVersion: kotlin.String? = null, xApiVersion: kotlin.String? = null, itemCategoryUpdateDto: ItemCategoryUpdateDto? = null) : Unit {
        val localVarResponse = updateItemCategoryAsyncWithHttpInfo(itemCategoryId = itemCategoryId, tenantId = tenantId, apiVersion = apiVersion, xApiVersion = xApiVersion, itemCategoryUpdateDto = itemCategoryUpdateDto)
     ...
     */
    @Throws(IllegalStateException::class, IOException::class)
    fun updateItemCategoryAsyncWithHttpInfo(itemCategoryId: java.util.UUID, tenantId: java.util.UUID, apiVersion: kotlin.String?, xApiVersion: kotlin.String?, itemCategoryUpdateDto: ItemCategoryUpdateDto?) : ApiResponse<Unit?> {
        val localVariableConfig = updateItemCategoryAsyncRequestConfig(itemCategoryId = itemCategoryId, tenantId = tenantId, apiVersion = apiVersion, xApiVersion = xApiVersion, itemCategoryUpdateDto = itemCategoryUpdateDto)

        return request<ItemCategoryUpdateDto, Unit>(
            localVariableConfig
        )
    }

    /**
     * To obtain the request config of the operation updateItemCategoryAsync
     *
     * @param itemCategoryId 
     * @param tenantId 
     * @param apiVersion  (optional)
     ...
     * @return RequestConfig
     */
    fun updateItemCategoryAsyncRequestConfig(itemCategoryId: java.util.UUID, tenantId: java.util.UUID, apiVersion: kotlin.String?, xApiVersion: kotlin.String?, itemCategoryUpdateDto: ItemCategoryUpdateDto?) : RequestConfig<ItemCategoryUpdateDto> {
        val localVariableBody = itemCategoryUpdateDto
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>()
            .apply {
                put("tenantId", listOf(tenantId.toString()))
                if (apiVersion != null) {
