...
class MerchantsApi(basePath: kotlin.String = defaultBasePath, client: Call.Factory = ApiClient.defaultClient) : ApiClient(basePath, client) {
    ...
    fun getMerchantById(merchantId: java.util.UUID, apiVersion: kotlin.String? = null, xApiVersion: kotlin.String? = null) : MerchantDtoEnvelope {
        val localVarResponse = getMerchantByIdWithHttpInfo(merchantId = merchantId, apiVersion = apiVersion, xApiVersion = xApiVersion)

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as MerchantDtoEnvelope
    ...
    fun getMerchantByIdWithHttpInfo(merchantId: java.util.UUID, apiVersion: kotlin.String?, xApiVersion: kotlin.String?) : ApiResponse<MerchantDtoEnvelope?> {
        val localVariableConfig = getMerchantByIdRequestConfig(merchantId = merchantId, apiVersion = apiVersion, xApiVersion = xApiVersion)

        return request<Unit, MerchantDtoEnvelope>(
            localVariableConfig
        )
    }

    /**
     * To obtain the request config of the operation getMerchantById
     *
     * @param merchantId 
     * @param apiVersion  (optional)
     * @param xApiVersion  (optional)
     ...
     */
    fun getMerchantByIdRequestConfig(merchantId: java.util.UUID, apiVersion: kotlin.String?, xApiVersion: kotlin.String?) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            ...
            path = "/api/v2/CatalogService/Merchants/{merchantId}".replace("{"+"merchantId"+"}", encodeURIComponent(merchantId.toString())),
    ...
    /**
     * To obtain the request config of the operation getMerchants
     *
     * @param apiVersion  (optional)
     * @param xApiVersion  (optional)
     * @return RequestConfig
    ...
    fun getMerchantsRequestConfig(apiVersion: kotlin.String?, xApiVersion: kotlin.String?) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/api/v2/CatalogService/Merchants",
            query = localVariableQuery,
            headers = localVariableHeaders,
            requiresAuthentication = false,
            body = localVariableBody
    ...
    /**
     * To obtain the request config of the operation getMerchantsCount
     *
     * @param apiVersion  (optional)
     * @param xApiVersion  (optional)
     * @return RequestConfig
    ...
    fun getMerchantsCountRequestConfig(apiVersion: kotlin.String?, xApiVersion: kotlin.String?) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/api/v2/CatalogService/Merchants/Count",
            query = localVariableQuery,
            headers = localVariableHeaders,
            requiresAuthentication = false,
            body = localVariableBody
