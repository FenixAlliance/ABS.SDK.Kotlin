...
val apiVersion : kotlin.String = apiVersion_example // kotlin.String | 
val xApiVersion : kotlin.String = xApiVersion_example // kotlin.String | 
val itemFamilyDtoCollectionQueryParameters : ItemFamilyDtoCollectionQueryParameters =  // ItemFamilyDtoCollectionQueryParameters | 
try {
    val result : ItemFamilyDtoListEnvelope = apiInstance.getItemFamiliesAsync(tenantId, apiVersion, xApiVersion, itemFamilyDtoCollectionQueryParameters)
    println(result)
} catch (e: ClientException) {
...
val itemFamilyDtoCollectionQueryParameters : ItemFamilyDtoCollectionQueryParameters =  // ItemFamilyDtoCollectionQueryParameters | 
try {
    val result : Int32Envelope = apiInstance.getItemFamiliesCountAsync(tenantId, apiVersion, xApiVersion, itemFamilyDtoCollectionQueryParameters)
    println(result)
} catch (e: ClientException) {
...
> EmptyEnvelope patchItemFamilyAsync(itemFamilyId, tenantId, apiVersion, xApiVersion, patchOperation)
...
try {
    val result : EmptyEnvelope = apiInstance.patchItemFamilyAsync(itemFamilyId, tenantId, apiVersion, xApiVersion, patchOperation)
    println(result)
} catch (e: ClientException) {
