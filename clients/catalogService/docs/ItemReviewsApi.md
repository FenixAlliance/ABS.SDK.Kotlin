...
> ItemReviewDtoEnvelope getItemReviewByIdAsync(itemReviewId, tenantId, apiVersion, xApiVersion)
...
val xApiVersion : kotlin.String = xApiVersion_example // kotlin.String | 
try {
    val result : ItemReviewDtoEnvelope = apiInstance.getItemReviewByIdAsync(itemReviewId, tenantId, apiVersion, xApiVersion)
    println(result)
} catch (e: ClientException) {
