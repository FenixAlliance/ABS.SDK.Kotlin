...
# **patchItemTagAsync**
> patchItemTagAsync(itemTagId, tenantId, apiVersion, xApiVersion, operation)
...
try {
    apiInstance.patchItemTagAsync(itemTagId, tenantId, apiVersion, xApiVersion, operation)
} catch (e: ClientException) {
