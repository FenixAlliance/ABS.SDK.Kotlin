...
val xApiVersion : kotlin.String = xApiVersion_example // kotlin.String | 
try {
    val result : ItemImageDtoEnvelope = apiInstance.getItemImageByIdAsync(itemImageId, tenantId, apiVersion, xApiVersion)
    println(result)
} catch (e: ClientException) {
...
try {
    val result : ItemImageDtoListEnvelope = apiInstance.getItemImagesAsync(tenantId, apiVersion, xApiVersion, itemImageDtoCollectionQueryParameters)
    println(result)
} catch (e: ClientException) {
...
# **patchItemImageAsync**
> patchItemImageAsync(itemImageId, tenantId, apiVersion, xApiVersion, patchOperation)
...
try {
    apiInstance.patchItemImageAsync(itemImageId, tenantId, apiVersion, xApiVersion, patchOperation)
} catch (e: ClientException) {
