...
# **patchEmployerAsync**
> EmptyEnvelope patchEmployerAsync(employerId, tenantId, apiVersion, xApiVersion, operation)
...
try {
    val result : EmptyEnvelope = apiInstance.patchEmployerAsync(employerId, tenantId, apiVersion, xApiVersion, operation)
    println(result)
} catch (e: ClientException) {
