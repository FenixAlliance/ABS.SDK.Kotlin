...
# **getEmployersAsync**
> EmployerProfileDtoListEnvelope getEmployersAsync(tenantId, apiVersion, xApiVersion, employerProfileDtoCollectionQueryParameters)
...
val apiVersion : kotlin.String = apiVersion_example // kotlin.String | 
val xApiVersion : kotlin.String = xApiVersion_example // kotlin.String | 
val employerProfileDtoCollectionQueryParameters : EmployerProfileDtoCollectionQueryParameters =  // EmployerProfileDtoCollectionQueryParameters | 
try {
    val result : EmployerProfileDtoListEnvelope = apiInstance.getEmployersAsync(tenantId, apiVersion, xApiVersion, employerProfileDtoCollectionQueryParameters)
    println(result)
} catch (e: ClientException) {
...
> Int32Envelope getEmployersCountAsync(tenantId, apiVersion, xApiVersion, employerProfileDtoCollectionQueryParameters)
...
val employerProfileDtoCollectionQueryParameters : EmployerProfileDtoCollectionQueryParameters =  // EmployerProfileDtoCollectionQueryParameters | 
try {
    val result : Int32Envelope = apiInstance.getEmployersCountAsync(tenantId, apiVersion, xApiVersion, employerProfileDtoCollectionQueryParameters)
    println(result)
} catch (e: ClientException) {
...
<a id="patchEmployerAsync"></a>
# **patchEmployerAsync**
> EmptyEnvelope patchEmployerAsync(employerId, tenantId, apiVersion, xApiVersion, patchOperation)
...
try {
    val result : EmptyEnvelope = apiInstance.patchEmployerAsync(employerId, tenantId, apiVersion, xApiVersion, patchOperation)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling EmployersApi#patchEmployerAsync")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling EmployersApi#patchEmployerAsync")
    e.printStackTrace()
}
```
