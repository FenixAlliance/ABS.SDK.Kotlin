...
val apiVersion : kotlin.String = apiVersion_example // kotlin.String | 
val xApiVersion : kotlin.String = xApiVersion_example // kotlin.String | 
val timeIntervalDtoCollectionQueryParameters : TimeIntervalDtoCollectionQueryParameters =  // TimeIntervalDtoCollectionQueryParameters | 
try {
    val result : TimeIntervalDtoListEnvelope = apiInstance.getTimeIntervalsAsync(tenantId, apiVersion, xApiVersion, timeIntervalDtoCollectionQueryParameters)
    println(result)
} catch (e: ClientException) {
...
val timeIntervalDtoCollectionQueryParameters : TimeIntervalDtoCollectionQueryParameters =  // TimeIntervalDtoCollectionQueryParameters | 
try {
    val result : Int32Envelope = apiInstance.getTimeIntervalsCountAsync(tenantId, apiVersion, xApiVersion, timeIntervalDtoCollectionQueryParameters)
    println(result)
} catch (e: ClientException) {
...
> EmptyEnvelope patchTimeIntervalAsync(timeIntervalId, tenantId, apiVersion, xApiVersion, patchOperation)
...
try {
    val result : EmptyEnvelope = apiInstance.patchTimeIntervalAsync(timeIntervalId, tenantId, apiVersion, xApiVersion, patchOperation)
    println(result)
} catch (e: ClientException) {
