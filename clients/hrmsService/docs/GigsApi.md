...
# **patchGigAsync**
> EmptyEnvelope patchGigAsync(gigId, tenantId, apiVersion, xApiVersion, operation)
...
try {
    val result : EmptyEnvelope = apiInstance.patchGigAsync(gigId, tenantId, apiVersion, xApiVersion, operation)
    println(result)
} catch (e: ClientException) {
