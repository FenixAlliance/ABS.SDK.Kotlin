...
# **getPayrollsAsync**
> PayrollDtoListEnvelope getPayrollsAsync(tenantId, apiVersion, xApiVersion, payrollDtoCollectionQueryParameters)
...
val apiVersion : kotlin.String = apiVersion_example // kotlin.String | 
val xApiVersion : kotlin.String = xApiVersion_example // kotlin.String | 
val payrollDtoCollectionQueryParameters : PayrollDtoCollectionQueryParameters =  // PayrollDtoCollectionQueryParameters | 
try {
    val result : PayrollDtoListEnvelope = apiInstance.getPayrollsAsync(tenantId, apiVersion, xApiVersion, payrollDtoCollectionQueryParameters)
    println(result)
} catch (e: ClientException) {
...
> Int32Envelope getPayrollsCountAsync(tenantId, apiVersion, xApiVersion, payrollDtoCollectionQueryParameters)
...
val payrollDtoCollectionQueryParameters : PayrollDtoCollectionQueryParameters =  // PayrollDtoCollectionQueryParameters | 
try {
    val result : Int32Envelope = apiInstance.getPayrollsCountAsync(tenantId, apiVersion, xApiVersion, payrollDtoCollectionQueryParameters)
    println(result)
} catch (e: ClientException) {
...
# **patchPayrollAsync**
> EmptyEnvelope patchPayrollAsync(payrollId, tenantId, apiVersion, xApiVersion, patchOperation)
...
try {
    val result : EmptyEnvelope = apiInstance.patchPayrollAsync(payrollId, tenantId, apiVersion, xApiVersion, patchOperation)
    println(result)
} catch (e: ClientException) {
