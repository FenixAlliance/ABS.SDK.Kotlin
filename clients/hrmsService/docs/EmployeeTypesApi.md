...
> EmptyEnvelope patchEmployeeTypeAsync(employeeTypeId, tenantId, apiVersion, xApiVersion, operation)
...
try {
    val result : EmptyEnvelope = apiInstance.patchEmployeeTypeAsync(employeeTypeId, tenantId, apiVersion, xApiVersion, operation)
    println(result)
} catch (e: ClientException) {
