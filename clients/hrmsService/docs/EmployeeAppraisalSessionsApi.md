...
> EmployeeAppraisalSessionDtoListEnvelope getEmployeeAppraisalSessionsAsync(tenantId, apiVersion, xApiVersion, employeeAppraisalSessionDtoCollectionQueryParameters)
...
val apiVersion : kotlin.String = apiVersion_example // kotlin.String | 
val xApiVersion : kotlin.String = xApiVersion_example // kotlin.String | 
val employeeAppraisalSessionDtoCollectionQueryParameters : EmployeeAppraisalSessionDtoCollectionQueryParameters =  // EmployeeAppraisalSessionDtoCollectionQueryParameters | 
try {
    val result : EmployeeAppraisalSessionDtoListEnvelope = apiInstance.getEmployeeAppraisalSessionsAsync(tenantId, apiVersion, xApiVersion, employeeAppraisalSessionDtoCollectionQueryParameters)
    println(result)
} catch (e: ClientException) {
...
> Int32Envelope getEmployeeAppraisalSessionsCountAsync(tenantId, apiVersion, xApiVersion, employeeAppraisalSessionDtoCollectionQueryParameters)
...
val employeeAppraisalSessionDtoCollectionQueryParameters : EmployeeAppraisalSessionDtoCollectionQueryParameters =  // EmployeeAppraisalSessionDtoCollectionQueryParameters | 
try {
    val result : Int32Envelope = apiInstance.getEmployeeAppraisalSessionsCountAsync(tenantId, apiVersion, xApiVersion, employeeAppraisalSessionDtoCollectionQueryParameters)
    println(result)
} catch (e: ClientException) {
...
> EmptyEnvelope patchEmployeeAppraisalSessionAsync(sessionId, tenantId, apiVersion, xApiVersion, patchOperation)
...
try {
    val result : EmptyEnvelope = apiInstance.patchEmployeeAppraisalSessionAsync(sessionId, tenantId, apiVersion, xApiVersion, patchOperation)
    println(result)
} catch (e: ClientException) {
