...
> ShippingMethodDtoListEnvelope getShippingMethodsAsync(tenantId, apiVersion, xApiVersion, shippingMethodDtoCollectionQueryParameters)
...
val apiVersion : kotlin.String = apiVersion_example // kotlin.String | 
val xApiVersion : kotlin.String = xApiVersion_example // kotlin.String | 
val shippingMethodDtoCollectionQueryParameters : ShippingMethodDtoCollectionQueryParameters =  // ShippingMethodDtoCollectionQueryParameters | 
try {
    val result : ShippingMethodDtoListEnvelope = apiInstance.getShippingMethodsAsync(tenantId, apiVersion, xApiVersion, shippingMethodDtoCollectionQueryParameters)
    println(result)
} catch (e: ClientException) {
...
> Int32Envelope getShippingMethodsCountAsync(tenantId, apiVersion, xApiVersion, shippingMethodDtoCollectionQueryParameters)
...
val shippingMethodDtoCollectionQueryParameters : ShippingMethodDtoCollectionQueryParameters =  // ShippingMethodDtoCollectionQueryParameters | 
try {
    val result : Int32Envelope = apiInstance.getShippingMethodsCountAsync(tenantId, apiVersion, xApiVersion, shippingMethodDtoCollectionQueryParameters)
    println(result)
} catch (e: ClientException) {
...
> EmptyEnvelope patchShippingMethodAsync(methodId, tenantId, apiVersion, xApiVersion, patchOperation)
...
try {
    val result : EmptyEnvelope = apiInstance.patchShippingMethodAsync(methodId, tenantId, apiVersion, xApiVersion, patchOperation)
    println(result)
} catch (e: ClientException) {
