...
data class ItemShippingPolicyCreateDto (
    ...
    val shippingCourierID: kotlin.String,
    ...
    @Json(name = "isExpressShipmentPolicy")
    val isExpressShipmentPolicy: kotlin.Boolean? = null,
