...
class WebhooksApi(basePath: kotlin.String = defaultBasePath, client: Call.Factory = ApiClient.defaultClient) : ApiClient(basePath, client) {
    ...
    /**
     * To obtain the request config of the operation getWebhookRequestsAsync
     *
     * @param tenantId 
     * @param apiVersion  (optional)
     * @param xApiVersion  (optional)
    ...
    fun getWebhookRequestsAsyncRequestConfig(tenantId: java.util.UUID, apiVersion: kotlin.String?, xApiVersion: kotlin.String?) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            ...
            path = "/api/v2/SecurityService/Webhooks",
    ...
    /**
     * To obtain the request config of the operation getWebhookRequestsCountAsync
     *
     * @param tenantId 
     * @param apiVersion  (optional)
     * @param xApiVersion  (optional)
    ...
    fun getWebhookRequestsCountAsyncRequestConfig(tenantId: java.util.UUID, apiVersion: kotlin.String?, xApiVersion: kotlin.String?) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/api/v2/SecurityService/Webhooks/Count",
            query = localVariableQuery,
            headers = localVariableHeaders,
            requiresAuthentication = false,
            body = localVariableBody
