...
class UsersApi(basePath: kotlin.String = defaultBasePath, client: Call.Factory = ApiClient.defaultClient) : ApiClient(basePath, client) {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getCurrentUserEnrollmentsAsync(apiVersion: kotlin.String? = null, xApiVersion: kotlin.String? = null) : TenantEnrollmentDtoListEnvelope {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getCurrentUserEnrollmentsAsyncWithHttpInfo(apiVersion: kotlin.String?, xApiVersion: kotlin.String?) : ApiResponse<TenantEnrollmentDtoListEnvelope?> {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getCurrentUserEnrollmentsExtendedAsync(apiVersion: kotlin.String? = null, xApiVersion: kotlin.String? = null) : ExtendedTenantEnrollmentDtoListEnvelope {
        val localVarResponse = getCurrentUserEnrollmentsExtendedAsyncWithHttpInfo(apiVersion = apiVersion, xApiVersion = xApiVersion)

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as ExtendedTenantEnrollmentDtoListEnvelope
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
     ...
     * @param apiVersion  (optional)
     * @param xApiVersion  (optional)
     * @return ApiResponse<ExtendedTenantEnrollmentDtoListEnvelope?>
     * @throws IllegalStateException If the request is not correctly configured
     * @throws IOException Rethrows the OkHttp execute method exception
     */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getCurrentUserEnrollmentsExtendedAsyncWithHttpInfo(apiVersion: kotlin.String?, xApiVersion: kotlin.String?) : ApiResponse<ExtendedTenantEnrollmentDtoListEnvelope?> {
        ...
        return request<Unit, ExtendedTenantEnrollmentDtoListEnvelope>(
            localVariableConfig
        )
    }
    ...
    fun getCurrentUserTenantsExtendedAsyncRequestConfig(apiVersion: kotlin.String?, xApiVersion: kotlin.String?) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/api/v2/Me/Tenants/Extended",
            query = localVariableQuery,
            headers = localVariableHeaders,
            requiresAuthentication = false,
            body = localVariableBody
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getEnrollmentAsync(enrollmentId: java.util.UUID, apiVersion: kotlin.String? = null, xApiVersion: kotlin.String? = null) : TenantEnrollmentDtoEnvelope {
        val localVarResponse = getEnrollmentAsyncWithHttpInfo(enrollmentId = enrollmentId, apiVersion = apiVersion, xApiVersion = xApiVersion)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getEnrollmentAsyncWithHttpInfo(enrollmentId: java.util.UUID, apiVersion: kotlin.String?, xApiVersion: kotlin.String?) : ApiResponse<TenantEnrollmentDtoEnvelope?> {
        val localVariableConfig = getEnrollmentAsyncRequestConfig(enrollmentId = enrollmentId, apiVersion = apiVersion, xApiVersion = xApiVersion)
    ...
    /**
     * To obtain the request config of the operation getEnrollmentAsync
     *
     * @param enrollmentId 
     * @param apiVersion  (optional)
     * @param xApiVersion  (optional)
     * @return RequestConfig
     */
    fun getEnrollmentAsyncRequestConfig(enrollmentId: java.util.UUID, apiVersion: kotlin.String?, xApiVersion: kotlin.String?) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>()
            .apply {
                if (apiVersion != null) {
