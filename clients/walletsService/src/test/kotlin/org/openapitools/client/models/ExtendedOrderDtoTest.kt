...
import org.openapitools.client.models.ExtendedOrderDto
...
class ExtendedOrderDtoTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of ExtendedOrderDto
        //val modelInstance = ExtendedOrderDto()
        ...
        // to test the property `orderLinesCount`
        should("test orderLinesCount") {
            // uncomment below to test the property
            //modelInstance.orderLinesCount shouldBe ("TODO")
        }
        ...
        // to test the property `parentOrderId`
        should("test parentOrderId") {
            // uncomment below to test the property
            //modelInstance.parentOrderId shouldBe ("TODO")
        }
        ...
        // to test the property `qualifiedIdentifier`
        should("test qualifiedIdentifier") {
            // uncomment below to test the property
            //modelInstance.qualifiedIdentifier shouldBe ("TODO")
        }
        ...
        // to test the property `requestedDeliveryDate`
        should("test requestedDeliveryDate") {
            // uncomment below to test the property
            //modelInstance.requestedDeliveryDate shouldBe ("TODO")
        }
