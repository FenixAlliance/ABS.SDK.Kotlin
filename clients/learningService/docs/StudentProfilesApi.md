...
> EmptyEnvelope apiV2LearningServiceStudentProfilesStudentProfileIdPatch(studentProfileId, tenantId, apiVersion, xApiVersion, patchOperation)
...
try {
    val result : EmptyEnvelope = apiInstance.apiV2LearningServiceStudentProfilesStudentProfileIdPatch(studentProfileId, tenantId, apiVersion, xApiVersion, patchOperation)
    println(result)
} catch (e: ClientException) {
