...
> EmptyEnvelope patchCourseCertificateAsync(courseCertificateId, tenantId, apiVersion, xApiVersion, patchOperation)
...
try {
    val result : EmptyEnvelope = apiInstance.patchCourseCertificateAsync(courseCertificateId, tenantId, apiVersion, xApiVersion, patchOperation)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling CourseCertificatesApi#patchCourseCertificateAsync")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling CourseCertificatesApi#patchCourseCertificateAsync")
    e.printStackTrace()
}
```
...
> EmptyEnvelope patchCourseCertificateTemplateAsync(courseCertificateTemplateId, tenantId, apiVersion, xApiVersion, patchOperation)
...
val patchOperation : kotlin.collections.List<PatchOperation> =  // kotlin.collections.List<PatchOperation> | 
try {
    val result : EmptyEnvelope = apiInstance.patchCourseCertificateTemplateAsync(courseCertificateTemplateId, tenantId, apiVersion, xApiVersion, patchOperation)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling CourseCertificatesApi#patchCourseCertificateTemplateAsync")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling CourseCertificatesApi#patchCourseCertificateTemplateAsync")
    e.printStackTrace()
}
```
