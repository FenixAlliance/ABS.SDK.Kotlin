...
> kotlin.collections.List&lt;CourseProblemSetDto&gt; getCourseProblemSetsAsync(tenantId, apiVersion, xApiVersion, courseProblemSetDtoCollectionQueryParameters)
...
try {
    val result : kotlin.collections.List<CourseProblemSetDto> = apiInstance.getCourseProblemSetsAsync(tenantId, apiVersion, xApiVersion, courseProblemSetDtoCollectionQueryParameters)
    println(result)
} catch (e: ClientException) {
...
> kotlin.Int getCourseProblemSetsCountAsync(tenantId, apiVersion, xApiVersion, courseProblemSetDtoCollectionQueryParameters)
...
val courseProblemSetDtoCollectionQueryParameters : CourseProblemSetDtoCollectionQueryParameters =  // CourseProblemSetDtoCollectionQueryParameters | 
try {
    val result : kotlin.Int = apiInstance.getCourseProblemSetsCountAsync(tenantId, apiVersion, xApiVersion, courseProblemSetDtoCollectionQueryParameters)
    println(result)
} catch (e: ClientException) {
...
> EmptyEnvelope patchCourseProblemSetAsync(problemSetId, tenantId, apiVersion, xApiVersion, patchOperation)
...
try {
    val result : EmptyEnvelope = apiInstance.patchCourseProblemSetAsync(problemSetId, tenantId, apiVersion, xApiVersion, patchOperation)
    println(result)
} catch (e: ClientException) {
