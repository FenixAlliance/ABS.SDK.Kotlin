...
> ContactRelationTypeDtoListEnvelope getContactRelationTypesAsync(tenantId, apiVersion, xApiVersion, contactRelationTypeDtoCollectionQueryParameters)
...
val apiVersion : kotlin.String = apiVersion_example // kotlin.String | 
val xApiVersion : kotlin.String = xApiVersion_example // kotlin.String | 
val contactRelationTypeDtoCollectionQueryParameters : ContactRelationTypeDtoCollectionQueryParameters =  // ContactRelationTypeDtoCollectionQueryParameters | 
try {
    val result : ContactRelationTypeDtoListEnvelope = apiInstance.getContactRelationTypesAsync(tenantId, apiVersion, xApiVersion, contactRelationTypeDtoCollectionQueryParameters)
    println(result)
} catch (e: ClientException) {
...
> Int32Envelope getContactRelationTypesCountAsync(tenantId, apiVersion, xApiVersion, contactRelationTypeDtoCollectionQueryParameters)
...
val contactRelationTypeDtoCollectionQueryParameters : ContactRelationTypeDtoCollectionQueryParameters =  // ContactRelationTypeDtoCollectionQueryParameters | 
try {
    val result : Int32Envelope = apiInstance.getContactRelationTypesCountAsync(tenantId, apiVersion, xApiVersion, contactRelationTypeDtoCollectionQueryParameters)
    println(result)
} catch (e: ClientException) {
...
> EmptyEnvelope patchContactRelationTypeAsync(id, tenantId, apiVersion, xApiVersion, patchOperation)
...
try {
    val result : EmptyEnvelope = apiInstance.patchContactRelationTypeAsync(id, tenantId, apiVersion, xApiVersion, patchOperation)
    println(result)
} catch (e: ClientException) {
