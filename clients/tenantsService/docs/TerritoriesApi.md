...
val apiVersion : kotlin.String = apiVersion_example // kotlin.String | 
val xApiVersion : kotlin.String = xApiVersion_example // kotlin.String | 
val tenantTerritoryDtoCollectionQueryParameters : TenantTerritoryDtoCollectionQueryParameters =  // TenantTerritoryDtoCollectionQueryParameters | 
try {
    val result : TenantTerritoryDtoListEnvelope = apiInstance.getTenantTerritories(tenantId, apiVersion, xApiVersion, tenantTerritoryDtoCollectionQueryParameters)
    println(result)
} catch (e: ClientException) {
...
val tenantTerritoryDtoCollectionQueryParameters : TenantTerritoryDtoCollectionQueryParameters =  // TenantTerritoryDtoCollectionQueryParameters | 
try {
    val result : Int32Envelope = apiInstance.getTenantTerritoriesCount(tenantId, apiVersion, xApiVersion, tenantTerritoryDtoCollectionQueryParameters)
    println(result)
} catch (e: ClientException) {
...
> EmptyEnvelope patchTenantTerritory(tenantTerritoryId, tenantId, apiVersion, xApiVersion, patchOperation)
...
try {
    val result : EmptyEnvelope = apiInstance.patchTenantTerritory(tenantTerritoryId, tenantId, apiVersion, xApiVersion, patchOperation)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling TerritoriesApi#patchTenantTerritory")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling TerritoriesApi#patchTenantTerritory")
    e.printStackTrace()
}
```
