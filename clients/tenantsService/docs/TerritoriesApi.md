...
> EmptyEnvelope patchTenantTerritory(tenantTerritoryId, tenantId, apiVersion, xApiVersion, operation)
...
try {
    val result : EmptyEnvelope = apiInstance.patchTenantTerritory(tenantTerritoryId, tenantId, apiVersion, xApiVersion, operation)
    println(result)
} catch (e: ClientException) {
