...
val apiVersion : kotlin.String = apiVersion_example // kotlin.String | 
val xApiVersion : kotlin.String = xApiVersion_example // kotlin.String | 
val tenantPositionDtoCollectionQueryParameters : TenantPositionDtoCollectionQueryParameters =  // TenantPositionDtoCollectionQueryParameters | 
try {
    val result : TenantPositionDtoListEnvelope = apiInstance.getTenantPositions(tenantId, apiVersion, xApiVersion, tenantPositionDtoCollectionQueryParameters)
    println(result)
} catch (e: ClientException) {
...
val tenantPositionDtoCollectionQueryParameters : TenantPositionDtoCollectionQueryParameters =  // TenantPositionDtoCollectionQueryParameters | 
try {
    val result : Int32Envelope = apiInstance.getTenantPositionsCount(tenantId, apiVersion, xApiVersion, tenantPositionDtoCollectionQueryParameters)
    println(result)
} catch (e: ClientException) {
...
# **patchTenantPosition**
> EmptyEnvelope patchTenantPosition(tenantPositionId, tenantId, apiVersion, xApiVersion, patchOperation)
...
try {
    val result : EmptyEnvelope = apiInstance.patchTenantPosition(tenantPositionId, tenantId, apiVersion, xApiVersion, patchOperation)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling PositionsApi#patchTenantPosition")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling PositionsApi#patchTenantPosition")
    e.printStackTrace()
}
```
