...
# **patchTenantPosition**
> EmptyEnvelope patchTenantPosition(tenantPositionId, tenantId, apiVersion, xApiVersion, operation)
...
try {
    val result : EmptyEnvelope = apiInstance.patchTenantPosition(tenantPositionId, tenantId, apiVersion, xApiVersion, operation)
    println(result)
} catch (e: ClientException) {
