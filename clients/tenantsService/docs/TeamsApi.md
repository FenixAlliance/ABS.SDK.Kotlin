...
# **getTenantTeams**
> TenantTeamDtoListEnvelope getTenantTeams(tenantId, apiVersion, xApiVersion, tenantTeamDtoCollectionQueryParameters)
...
val apiVersion : kotlin.String = apiVersion_example // kotlin.String | 
val xApiVersion : kotlin.String = xApiVersion_example // kotlin.String | 
val tenantTeamDtoCollectionQueryParameters : TenantTeamDtoCollectionQueryParameters =  // TenantTeamDtoCollectionQueryParameters | 
try {
    val result : TenantTeamDtoListEnvelope = apiInstance.getTenantTeams(tenantId, apiVersion, xApiVersion, tenantTeamDtoCollectionQueryParameters)
    println(result)
} catch (e: ClientException) {
...
# **getTenantTeamsCount**
> Int32Envelope getTenantTeamsCount(tenantId, apiVersion, xApiVersion, tenantTeamDtoCollectionQueryParameters)
...
val tenantTeamDtoCollectionQueryParameters : TenantTeamDtoCollectionQueryParameters =  // TenantTeamDtoCollectionQueryParameters | 
try {
    val result : Int32Envelope = apiInstance.getTenantTeamsCount(tenantId, apiVersion, xApiVersion, tenantTeamDtoCollectionQueryParameters)
    println(result)
} catch (e: ClientException) {
...
<a id="patchTenantTeam"></a>
# **patchTenantTeam**
> EmptyEnvelope patchTenantTeam(tenantTeamId, tenantId, apiVersion, xApiVersion, patchOperation)
...
try {
    val result : EmptyEnvelope = apiInstance.patchTenantTeam(tenantTeamId, tenantId, apiVersion, xApiVersion, patchOperation)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling TeamsApi#patchTenantTeam")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling TeamsApi#patchTenantTeam")
    e.printStackTrace()
}
```
