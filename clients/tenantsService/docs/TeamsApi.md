...
# **patchTenantTeam**
> EmptyEnvelope patchTenantTeam(tenantTeamId, tenantId, apiVersion, xApiVersion, operation)
...
try {
    val result : EmptyEnvelope = apiInstance.patchTenantTeam(tenantTeamId, tenantId, apiVersion, xApiVersion, operation)
    println(result)
} catch (e: ClientException) {
