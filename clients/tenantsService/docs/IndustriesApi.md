...
> EmptyEnvelope patchTenantIndustryAsync(tenantIndustryId, tenantId, apiVersion, xApiVersion, operation)
...
try {
    val result : EmptyEnvelope = apiInstance.patchTenantIndustryAsync(tenantIndustryId, tenantId, apiVersion, xApiVersion, operation)
    println(result)
} catch (e: ClientException) {
