...
# **getTenantIndustries**
> TenantIndustryDtoListEnvelope getTenantIndustries(tenantId, apiVersion, xApiVersion, tenantIndustryDtoCollectionQueryParameters)
...
val apiVersion : kotlin.String = apiVersion_example // kotlin.String | 
val xApiVersion : kotlin.String = xApiVersion_example // kotlin.String | 
val tenantIndustryDtoCollectionQueryParameters : TenantIndustryDtoCollectionQueryParameters =  // TenantIndustryDtoCollectionQueryParameters | 
try {
    val result : TenantIndustryDtoListEnvelope = apiInstance.getTenantIndustries(tenantId, apiVersion, xApiVersion, tenantIndustryDtoCollectionQueryParameters)
    println(result)
} catch (e: ClientException) {
...
> Int32Envelope getTenantIndustriesCount(tenantId, apiVersion, xApiVersion, tenantIndustryDtoCollectionQueryParameters)
...
val tenantIndustryDtoCollectionQueryParameters : TenantIndustryDtoCollectionQueryParameters =  // TenantIndustryDtoCollectionQueryParameters | 
try {
    val result : Int32Envelope = apiInstance.getTenantIndustriesCount(tenantId, apiVersion, xApiVersion, tenantIndustryDtoCollectionQueryParameters)
    println(result)
} catch (e: ClientException) {
...
<a id="patchTenantIndustryAsync"></a>
# **patchTenantIndustryAsync**
> EmptyEnvelope patchTenantIndustryAsync(tenantIndustryId, tenantId, apiVersion, xApiVersion, patchOperation)
...
try {
    val result : EmptyEnvelope = apiInstance.patchTenantIndustryAsync(tenantIndustryId, tenantId, apiVersion, xApiVersion, patchOperation)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling IndustriesApi#patchTenantIndustryAsync")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling IndustriesApi#patchTenantIndustryAsync")
    e.printStackTrace()
}
```
