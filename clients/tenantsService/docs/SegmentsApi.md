...
# **patchTenantSegment**
> EmptyEnvelope patchTenantSegment(tenantSegmentId, tenantId, apiVersion, xApiVersion, operation)
...
try {
    val result : EmptyEnvelope = apiInstance.patchTenantSegment(tenantSegmentId, tenantId, apiVersion, xApiVersion, operation)
    println(result)
} catch (e: ClientException) {
