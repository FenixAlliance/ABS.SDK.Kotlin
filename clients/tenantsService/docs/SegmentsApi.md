...
val apiVersion : kotlin.String = apiVersion_example // kotlin.String | 
val xApiVersion : kotlin.String = xApiVersion_example // kotlin.String | 
val tenantSegmentDtoCollectionQueryParameters : TenantSegmentDtoCollectionQueryParameters =  // TenantSegmentDtoCollectionQueryParameters | 
try {
    val result : TenantSegmentDtoListEnvelope = apiInstance.getTenantSegments(tenantId, apiVersion, xApiVersion, tenantSegmentDtoCollectionQueryParameters)
    println(result)
} catch (e: ClientException) {
...
val tenantSegmentDtoCollectionQueryParameters : TenantSegmentDtoCollectionQueryParameters =  // TenantSegmentDtoCollectionQueryParameters | 
try {
    val result : Int32Envelope = apiInstance.getTenantSegmentsCount(tenantId, apiVersion, xApiVersion, tenantSegmentDtoCollectionQueryParameters)
    println(result)
} catch (e: ClientException) {
...
# **patchTenantSegment**
> EmptyEnvelope patchTenantSegment(tenantSegmentId, tenantId, apiVersion, xApiVersion, patchOperation)
...
try {
    val result : EmptyEnvelope = apiInstance.patchTenantSegment(tenantSegmentId, tenantId, apiVersion, xApiVersion, patchOperation)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling SegmentsApi#patchTenantSegment")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling SegmentsApi#patchTenantSegment")
    e.printStackTrace()
}
```
