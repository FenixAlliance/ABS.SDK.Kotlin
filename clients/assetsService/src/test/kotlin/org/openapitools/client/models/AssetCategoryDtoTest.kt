...
class AssetCategoryDtoTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of AssetCategoryDto
        //val modelInstance = AssetCategoryDto()
        ...
        // to test the property `assetCount`
        should("test assetCount") {
            // uncomment below to test the property
            //modelInstance.assetCount shouldBe ("TODO")
        }
