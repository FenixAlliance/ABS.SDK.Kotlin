...
> EmptyEnvelope patchMaintenanceVisitAsync(maintenanceVisitId, tenantId, apiVersion, xApiVersion, operation)
...
try {
    val result : EmptyEnvelope = apiInstance.patchMaintenanceVisitAsync(maintenanceVisitId, tenantId, apiVersion, xApiVersion, operation)
    println(result)
} catch (e: ClientException) {
