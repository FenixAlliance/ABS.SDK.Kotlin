...
> EmptyEnvelope patchRefundRequestAsync(refundRequestId, tenantId, apiVersion, xApiVersion, operation)
...
try {
    val result : EmptyEnvelope = apiInstance.patchRefundRequestAsync(refundRequestId, tenantId, apiVersion, xApiVersion, operation)
    println(result)
} catch (e: ClientException) {
