...
try {
    val result : ItemWarrantyPolicyDtoListEnvelope = apiInstance.getWarrantyPoliciesAsync(tenantId, apiVersion, xApiVersion, itemWarrantyPolicyDtoCollectionQueryParameters)
    println(result)
} catch (e: ClientException) {
...
val itemWarrantyPolicyDtoCollectionQueryParameters : ItemWarrantyPolicyDtoCollectionQueryParameters =  // ItemWarrantyPolicyDtoCollectionQueryParameters | 
try {
    val result : Int32Envelope = apiInstance.getWarrantyPoliciesCountAsync(tenantId, apiVersion, xApiVersion, itemWarrantyPolicyDtoCollectionQueryParameters)
    println(result)
} catch (e: ClientException) {
...
> EmptyEnvelope patchWarrantyPolicyAsync(warrantyPolicyId, tenantId, apiVersion, xApiVersion, patchOperation)
...
try {
    val result : EmptyEnvelope = apiInstance.patchWarrantyPolicyAsync(warrantyPolicyId, tenantId, apiVersion, xApiVersion, patchOperation)
    println(result)
} catch (e: ClientException) {
