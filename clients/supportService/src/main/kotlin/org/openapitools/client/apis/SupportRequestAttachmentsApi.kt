...
class SupportRequestAttachmentsApi(basePath: kotlin.String = defaultBasePath, client: Call.Factory = ApiClient.defaultClient) : ApiClient(basePath, client) {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getSupportRequestAttachmentsAsync(tenantId: java.util.UUID, apiVersion: kotlin.String? = null, xApiVersion: kotlin.String? = null, supportRequestAttachmentDtoCollectionQueryParameters: SupportRequestAttachmentDtoCollectionQueryParameters? = null) : SupportRequestAttachmentDtoListEnvelope {
        val localVarResponse = getSupportRequestAttachmentsAsyncWithHttpInfo(tenantId = tenantId, apiVersion = apiVersion, xApiVersion = xApiVersion, supportRequestAttachmentDtoCollectionQueryParameters = supportRequestAttachmentDtoCollectionQueryParameters)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getSupportRequestAttachmentsAsyncWithHttpInfo(tenantId: java.util.UUID, apiVersion: kotlin.String?, xApiVersion: kotlin.String?, supportRequestAttachmentDtoCollectionQueryParameters: SupportRequestAttachmentDtoCollectionQueryParameters?) : ApiResponse<SupportRequestAttachmentDtoListEnvelope?> {
        val localVariableConfig = getSupportRequestAttachmentsAsyncRequestConfig(tenantId = tenantId, apiVersion = apiVersion, xApiVersion = xApiVersion, supportRequestAttachmentDtoCollectionQueryParameters = supportRequestAttachmentDtoCollectionQueryParameters)
     ...
     * @return RequestConfig
     */
    fun getSupportRequestAttachmentsAsyncRequestConfig(tenantId: java.util.UUID, apiVersion: kotlin.String?, xApiVersion: kotlin.String?, supportRequestAttachmentDtoCollectionQueryParameters: SupportRequestAttachmentDtoCollectionQueryParameters?) : RequestConfig<SupportRequestAttachmentDtoCollectionQueryParameters> {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getSupportRequestAttachmentsCountAsync(tenantId: java.util.UUID, apiVersion: kotlin.String? = null, xApiVersion: kotlin.String? = null, supportRequestAttachmentDtoCollectionQueryParameters: SupportRequestAttachmentDtoCollectionQueryParameters? = null) : Int32Envelope {
        val localVarResponse = getSupportRequestAttachmentsCountAsyncWithHttpInfo(tenantId = tenantId, apiVersion = apiVersion, xApiVersion = xApiVersion, supportRequestAttachmentDtoCollectionQueryParameters = supportRequestAttachmentDtoCollectionQueryParameters)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getSupportRequestAttachmentsCountAsyncWithHttpInfo(tenantId: java.util.UUID, apiVersion: kotlin.String?, xApiVersion: kotlin.String?, supportRequestAttachmentDtoCollectionQueryParameters: SupportRequestAttachmentDtoCollectionQueryParameters?) : ApiResponse<Int32Envelope?> {
        val localVariableConfig = getSupportRequestAttachmentsCountAsyncRequestConfig(tenantId = tenantId, apiVersion = apiVersion, xApiVersion = xApiVersion, supportRequestAttachmentDtoCollectionQueryParameters = supportRequestAttachmentDtoCollectionQueryParameters)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun patchSupportRequestAttachmentAsync(supportRequestAttachmentId: java.util.UUID, tenantId: java.util.UUID, apiVersion: kotlin.String? = null, xApiVersion: kotlin.String? = null, patchOperation: kotlin.collections.List<PatchOperation>? = null) : EmptyEnvelope {
        val localVarResponse = patchSupportRequestAttachmentAsyncWithHttpInfo(supportRequestAttachmentId = supportRequestAttachmentId, tenantId = tenantId, apiVersion = apiVersion, xApiVersion = xApiVersion, patchOperation = patchOperation)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun patchSupportRequestAttachmentAsyncWithHttpInfo(supportRequestAttachmentId: java.util.UUID, tenantId: java.util.UUID, apiVersion: kotlin.String?, xApiVersion: kotlin.String?, patchOperation: kotlin.collections.List<PatchOperation>?) : ApiResponse<EmptyEnvelope?> {
        val localVariableConfig = patchSupportRequestAttachmentAsyncRequestConfig(supportRequestAttachmentId = supportRequestAttachmentId, tenantId = tenantId, apiVersion = apiVersion, xApiVersion = xApiVersion, patchOperation = patchOperation)
    ...
    /**
     * To obtain the request config of the operation patchSupportRequestAttachmentAsync
     *
     * @param supportRequestAttachmentId 
     * @param tenantId 
     * @param apiVersion  (optional)
     ...
     * @return RequestConfig
     */
    fun patchSupportRequestAttachmentAsyncRequestConfig(supportRequestAttachmentId: java.util.UUID, tenantId: java.util.UUID, apiVersion: kotlin.String?, xApiVersion: kotlin.String?, patchOperation: kotlin.collections.List<PatchOperation>?) : RequestConfig<kotlin.collections.List<PatchOperation>> {
