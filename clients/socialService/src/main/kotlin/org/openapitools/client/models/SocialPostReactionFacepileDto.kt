...
data class SocialPostReactionFacepileDto (
    ...
    val socialProfileType: SocialPostReactionFacepileDto.SocialProfileType? = null,

    @Json(name = "reaction")
    val reaction: SocialPostReactionFacepileDto.Reaction? = null
