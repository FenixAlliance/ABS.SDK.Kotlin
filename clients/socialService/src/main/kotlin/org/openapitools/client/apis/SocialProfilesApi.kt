...
class SocialProfilesApi(basePath: kotlin.String = defaultBasePath, client: Call.Factory = ApiClient.defaultClient) : ApiClient(basePath, client) {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getNotificationByIdAsync(socialProfileId: java.util.UUID, notificationId: java.util.UUID, apiVersion: kotlin.String? = null, xApiVersion: kotlin.String? = null) : NotificationDtoEnvelope {
        val localVarResponse = getNotificationByIdAsyncWithHttpInfo(socialProfileId = socialProfileId, notificationId = notificationId, apiVersion = apiVersion, xApiVersion = xApiVersion)

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as NotificationDtoEnvelope
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
     ...
     * @param apiVersion  (optional)
     * @param xApiVersion  (optional)
     * @return ApiResponse<NotificationDtoEnvelope?>
     * @throws IllegalStateException If the request is not correctly configured
     * @throws IOException Rethrows the OkHttp execute method exception
     */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getNotificationByIdAsyncWithHttpInfo(socialProfileId: java.util.UUID, notificationId: java.util.UUID, apiVersion: kotlin.String?, xApiVersion: kotlin.String?) : ApiResponse<NotificationDtoEnvelope?> {
        val localVariableConfig = getNotificationByIdAsyncRequestConfig(socialProfileId = socialProfileId, notificationId = notificationId, apiVersion = apiVersion, xApiVersion = xApiVersion)

        return request<Unit, NotificationDtoEnvelope>(
            localVariableConfig
        )
    }

    /**
     * To obtain the request config of the operation getNotificationByIdAsync
     *
     * @param socialProfileId 
     * @param notificationId 
     * @param apiVersion  (optional)
     ...
     * @return RequestConfig
     */
    fun getNotificationByIdAsyncRequestConfig(socialProfileId: java.util.UUID, notificationId: java.util.UUID, apiVersion: kotlin.String?, xApiVersion: kotlin.String?) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>()
            .apply {
                if (apiVersion != null) {
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/api/v2/SocialService/SocialProfiles/{socialProfileId}/Notifications/{notificationId}".replace("{"+"socialProfileId"+"}", encodeURIComponent(socialProfileId.toString())).replace("{"+"notificationId"+"}", encodeURIComponent(notificationId.toString())),
            query = localVariableQuery,
            headers = localVariableHeaders,
            requiresAuthentication = false,
            body = localVariableBody
