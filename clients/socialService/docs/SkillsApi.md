...
val apiVersion : kotlin.String = apiVersion_example // kotlin.String | 
val xApiVersion : kotlin.String = xApiVersion_example // kotlin.String | 
val skillDtoCollectionQueryParameters : SkillDtoCollectionQueryParameters =  // SkillDtoCollectionQueryParameters | 
try {
    val result : SkillDtoListEnvelope = apiInstance.getSkillsAsync(tenantId, apiVersion, xApiVersion, skillDtoCollectionQueryParameters)
    println(result)
} catch (e: ClientException) {
...
val skillDtoCollectionQueryParameters : SkillDtoCollectionQueryParameters =  // SkillDtoCollectionQueryParameters | 
try {
    val result : Int32Envelope = apiInstance.getSkillsCountAsync(tenantId, apiVersion, xApiVersion, skillDtoCollectionQueryParameters)
    println(result)
} catch (e: ClientException) {
...
# **patchSkillAsync**
> EmptyEnvelope patchSkillAsync(skillId, tenantId, apiVersion, xApiVersion, patchOperation)
...
try {
    val result : EmptyEnvelope = apiInstance.patchSkillAsync(skillId, tenantId, apiVersion, xApiVersion, patchOperation)
    println(result)
} catch (e: ClientException) {
