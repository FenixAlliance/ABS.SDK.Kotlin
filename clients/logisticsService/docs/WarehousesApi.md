...
# **getWarehousesAsync**
> WarehouseDtoListEnvelope getWarehousesAsync(tenantId, apiVersion, xApiVersion, warehouseDtoCollectionQueryParameters)
...
val apiVersion : kotlin.String = apiVersion_example // kotlin.String | 
val xApiVersion : kotlin.String = xApiVersion_example // kotlin.String | 
val warehouseDtoCollectionQueryParameters : WarehouseDtoCollectionQueryParameters =  // WarehouseDtoCollectionQueryParameters | 
try {
    val result : WarehouseDtoListEnvelope = apiInstance.getWarehousesAsync(tenantId, apiVersion, xApiVersion, warehouseDtoCollectionQueryParameters)
    println(result)
} catch (e: ClientException) {
...
> Int32Envelope getWarehousesCountAsync(tenantId, apiVersion, xApiVersion, warehouseDtoCollectionQueryParameters)
...
val warehouseDtoCollectionQueryParameters : WarehouseDtoCollectionQueryParameters =  // WarehouseDtoCollectionQueryParameters | 
try {
    val result : Int32Envelope = apiInstance.getWarehousesCountAsync(tenantId, apiVersion, xApiVersion, warehouseDtoCollectionQueryParameters)
    println(result)
} catch (e: ClientException) {
...
# **patchWarehouseAsync**
> EmptyEnvelope patchWarehouseAsync(warehouseId, tenantId, apiVersion, xApiVersion, patchOperation)
...
try {
    val result : EmptyEnvelope = apiInstance.patchWarehouseAsync(warehouseId, tenantId, apiVersion, xApiVersion, patchOperation)
    println(result)
} catch (e: ClientException) {
