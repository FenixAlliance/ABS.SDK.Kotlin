...
class ItemPickListEntryDtoTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of ItemPickListEntryDto
        //val modelInstance = ItemPickListEntryDto()
        ...
        // to test the property `itemPickListId`
        should("test itemPickListId") {
            // uncomment below to test the property
            //modelInstance.itemPickListId shouldBe ("TODO")
        }
