...
> Envelope patchServiceLevelAgreementAsync(serviceLevelAgreementId, tenantId, apiVersion, xApiVersion, operation)
...
try {
    val result : Envelope = apiInstance.patchServiceLevelAgreementAsync(serviceLevelAgreementId, tenantId, apiVersion, xApiVersion, operation)
    println(result)
} catch (e: ClientException) {
