...
data class ExtendedInvoiceDto (
    ...
    val taxCalculationMethod: ExtendedInvoiceDto.TaxCalculationMethod? = null,

    @Json(name = "costCalculationMethod")
    val costCalculationMethod: ExtendedInvoiceDto.CostCalculationMethod? = null,
    ...
    val invoiceType: ExtendedInvoiceDto.InvoiceType? = null,

    @Json(name = "documentType")
    val documentType: ExtendedInvoiceDto.DocumentType? = null,

    @Json(name = "invoiceStatus")
    val invoiceStatus: ExtendedInvoiceDto.InvoiceStatus? = null,
    ...
    val individual: SimpleContactDto? = null,

    @Json(name = "organization")
    val organization: SimpleContactDto? = null,

    @Json(name = "enrollment")
    val enrollment: SimpleTenantEnrollmentDto? = null,

    @Json(name = "invoiceLines")
    val invoiceLines: kotlin.collections.List<InvoiceLineDto>? = null
