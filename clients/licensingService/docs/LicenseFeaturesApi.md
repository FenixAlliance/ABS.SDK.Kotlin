...
> LicenseFeatureDtoListEnvelope getLicenseFeaturesAsync(tenantId, apiVersion, xApiVersion, licenseFeatureDtoCollectionQueryParameters)
...
val apiVersion : kotlin.String = apiVersion_example // kotlin.String | 
val xApiVersion : kotlin.String = xApiVersion_example // kotlin.String | 
val licenseFeatureDtoCollectionQueryParameters : LicenseFeatureDtoCollectionQueryParameters =  // LicenseFeatureDtoCollectionQueryParameters | 
try {
    val result : LicenseFeatureDtoListEnvelope = apiInstance.getLicenseFeaturesAsync(tenantId, apiVersion, xApiVersion, licenseFeatureDtoCollectionQueryParameters)
    println(result)
} catch (e: ClientException) {
...
> Int32Envelope getLicenseFeaturesCountAsync(tenantId, apiVersion, xApiVersion, licenseFeatureDtoCollectionQueryParameters)
...
val licenseFeatureDtoCollectionQueryParameters : LicenseFeatureDtoCollectionQueryParameters =  // LicenseFeatureDtoCollectionQueryParameters | 
try {
    val result : Int32Envelope = apiInstance.getLicenseFeaturesCountAsync(tenantId, apiVersion, xApiVersion, licenseFeatureDtoCollectionQueryParameters)
    println(result)
} catch (e: ClientException) {
...
> EmptyEnvelope patchLicenseFeatureAsync(id, tenantId, apiVersion, xApiVersion, patchOperation)
...
try {
    val result : EmptyEnvelope = apiInstance.patchLicenseFeatureAsync(id, tenantId, apiVersion, xApiVersion, patchOperation)
    println(result)
} catch (e: ClientException) {
