...
> LicenseAttributeDtoListEnvelope getLicenseAttributesAsync(tenantId, apiVersion, xApiVersion, licenseAttributeDtoCollectionQueryParameters)
...
val apiVersion : kotlin.String = apiVersion_example // kotlin.String | 
val xApiVersion : kotlin.String = xApiVersion_example // kotlin.String | 
val licenseAttributeDtoCollectionQueryParameters : LicenseAttributeDtoCollectionQueryParameters =  // LicenseAttributeDtoCollectionQueryParameters | 
try {
    val result : LicenseAttributeDtoListEnvelope = apiInstance.getLicenseAttributesAsync(tenantId, apiVersion, xApiVersion, licenseAttributeDtoCollectionQueryParameters)
    println(result)
} catch (e: ClientException) {
...
> Int32Envelope getLicenseAttributesCountAsync(tenantId, apiVersion, xApiVersion, licenseAttributeDtoCollectionQueryParameters)
...
val licenseAttributeDtoCollectionQueryParameters : LicenseAttributeDtoCollectionQueryParameters =  // LicenseAttributeDtoCollectionQueryParameters | 
try {
    val result : Int32Envelope = apiInstance.getLicenseAttributesCountAsync(tenantId, apiVersion, xApiVersion, licenseAttributeDtoCollectionQueryParameters)
    println(result)
} catch (e: ClientException) {
...
> EmptyEnvelope patchLicenseAttributeAsync(id, tenantId, apiVersion, xApiVersion, patchOperation)
...
try {
    val result : EmptyEnvelope = apiInstance.patchLicenseAttributeAsync(id, tenantId, apiVersion, xApiVersion, patchOperation)
    println(result)
} catch (e: ClientException) {
